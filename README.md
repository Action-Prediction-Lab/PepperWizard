...
*   `W`    - Wake Up Robot
*   `R`    - Put Robot to Rest
*   `T`    - Enter Text-to-Speech mode
*   `AT`   - Enter Animated Text-to-Speech mode
...
*   **`animations.json`**: Maps animation names to single-character keys for use in the "Animated Talk" mode.
